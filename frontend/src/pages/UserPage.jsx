...
export default function UserProfilePage() {
  ...
  const canViewGallery = user.visibility === "public" || isFollowing;
      ...
      <div className="bg-gradient-to-r from-red-50 to-red-100 rounded-xl p-6 mb-8 shadow-sm">
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="relative">
            <div className="w-32 h-32 md:w-40 md:h-40 rounded-full bg-gradient-to-tr from-red-400 via-red-500 to-red-600 p-[3px] shadow-lg">
              <img
                src={image}
                alt={user.name}
            ...
            {user.verified && (
              <Badge className="absolute bottom-1 right-1 bg-blue-500 border-2 border-white">
        ...
        <CardContent className="p-6">
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-y-4 gap-x-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {user.birthday ? `${calculateAge(user.birthday)} years` : "N/A"}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                <Languages className="h-4 w-4 mr-2 text-red-400" />
                <div>
